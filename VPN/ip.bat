...
@rem "d:\Program Files\PortableGit\bin\git" config --global user.name "Bibibof"
@rem "d:\Program Files\PortableGit\bin\git" config --global user.email bibibof@hotmail.com
@rem "d:\Program Files\PortableGit\bin\git" config --global credential.helper cache
